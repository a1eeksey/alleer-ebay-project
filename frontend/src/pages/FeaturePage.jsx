  ...
  return (
    <div className="page">
      <div className="container">
        <Navbar_Landing />
        <div className="main">
          <Home_Header title="Feature" text="An overview of our versatile, intuitive, and optimized tools" paragraph="Detailed insights into the diversity of ALLEER: Here, you will discover the multifaceted features of our platform - from efficient item management, streamlined order processing, intelligent analysis tools, to customizable templates and notifications - all carefully designed to simplify, automate, and ultimately optimize your eBay business." image={feature}/>
          <Feature_Main />
        </div>
    </div>
    <Footer />
